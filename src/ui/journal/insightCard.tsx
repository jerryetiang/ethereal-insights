...
const InsightCard: React.FC<InsightCardProps> = ({ title, description, icon }) => {
  return (
    <div>
      <div
        className="transition-all theme-transition duration-50 bg-zinc-50 hover:bg-zinc-100 dark:bg-zinc-950 dark:hover:bg-zinc-900 hover:shadow-xl m-2 p-4 relative group cursor-pointer"
      >
        ...
        <div className="flex items-center py-2 px-9 relative">
          ...
          {/* Title */}
          <h3 className="text-lg font-semibold text-zinc-700 dark:text-lime-400">{title}</h3>
        </div>
