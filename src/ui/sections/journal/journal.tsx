...
export default function ProductPage() {
  return (
    <div className="container md:p-16 sm:p-4 mx-auto my-8 mt-4 grid grid-cols-1 md:grid-cols-2 gap-8 dark:bg-black bg-white theme-transition">
      ...
      {/* Column - Product Image, Price, Title, and Purchase Button */}
