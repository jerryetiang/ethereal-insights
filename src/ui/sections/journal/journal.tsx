    ...
    <div className="container mx-auto my-8 mt-4 grid grid-cols-1 md:grid-cols-2 gap-8 dark:bg-black bg-white theme-transition">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mt-4 text-center">
          <h2 className="text-xl font-semibold">Illuminations</h2>
          <p className="text-gray-600">Price: $9.99</p>
      ...
      <div className="p-2">
        <h2 className="text-4xl font-semibold mb-4">
          Illuminations: An Idea Journal by Ethereal Insights
        </h2>
        <p className="text-gray-800 font-medium dark:text-gray-300 text-lg mt-4 theme-transition">
          Unleash your creativity with Ethereal Illuminations—an idea journal
          designed to capture the essence of your deepest musings. Elevate your
          thoughts, spark inspiration, and embark on a journey of
          self-discovery.
        </p>
        <p className="text-md dark:text-gray-500 text-gray-600 mt-4 theme-transition">
          <strong className="text-md">Illuminations</strong> is not just a
          journal; it is a companion on your quest for creativity and
          self-discovery. Immerse yourself in the ethereal realm of thoughts as
          you fill its pages with ideas, reflections, and the profound musings
          that define your unique journey. This carefully crafted idea journal
          by Ethereal Insights is more than a blank canvas; it is s a space
          where your innermost thoughts come to life, sparking inspiration and
          fostering a deeper connection with your creative self.
        </p>
        <section className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:mt-20 ">
          <InsightCard
            title="Great Design"
            description="Illuminations incorporates a Lay-flat hardcover indexed with dot grid and an inner pocket marrying aesthetics and function for an exceptional writing experience."
            icon={
              <svg
          ...
          {/* You can use multiple InsightCard components with different data */}
          <InsightCard
            title="Maximum Productivity"
            description="With perforated habit trackers and daily quotes for inspiration, Illuminations maximizes productivity and creativity effortlessly."
            icon={
              <svg
                className="w-16 h-16 fill-gray-400 dark:group-hover:fill-gray-100 group-hover:fill-black theme-transition"
                aria-hidden="true"
