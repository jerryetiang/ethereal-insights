      ...
      <div className="w-full md:w-2/3 p-4 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {featuredData.map((post, index) => (
            ...
            >
              <h5 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">
                {post.title}
              </h5>
              <p className="text-sm text-zinc-700 dark:text-zinc-400">
                {post.cardDescription}
              </p>
              <Button className="text-white bg-zinc-800 border border-transparent hover:bg-zinc-900 focus:ring-4 focus:ring-zinc-300 dark:bg-zinc-800 hover:dark:hover:bg-zinc-700 focus:dark:focus:ring-zinc-800 dark:border-zinc-700">
                Read more
                <svg
