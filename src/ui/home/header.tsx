...
export default function Header() {
  return (
    <div className="dark:bg-black dark:text-light bg-white relative flex items-center  n justify-center overflow-hidden ">
      <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className=" relative ">
            ...
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              ...
              <h2 className="mb-6 max-w-lg text-4xl font-light leading-snug tracking-tight text-g1 sm:text-5xl sm:leading-snug">
                Thought provoking
                <span className="my-1 inline-block border-b-8 border-g4 bg-white dark:bg-black px-4 font-bold text-g4 animate__animated animate__flash">
                  Musings
                </span>
              </h2>
          ...
          <div className="relative hidden lg:ml-4 lg:block lg:w-1/2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="my-6 mx-auto h-10 w-10 animate-bounce rounded-full bg-white dark:bg-black p-2 lg:hidden"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
            ...
            <div className="bg-white dark:bg-black mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
              <Image
      ...
      <div className=" absolute top-10 left-3/4 z-0  opacity-10 ">
        <svg
          ...
          viewBox="0 0 256 256"
          xmlns="http://www.w3.org/2000/svg"
          className="w-96 z-0 h-full object-fill fill-green-300 text-green-300"
        >
          <path
