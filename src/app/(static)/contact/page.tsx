...
const insights = [
  {
    ...
    icon: (
      <svg className="w-10 h-10 fill-zinc-400 dark:group-hover:fill-zinc-100 group-hover:fill-zinc-900 theme-transition" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 19 18">
